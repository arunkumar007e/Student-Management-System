...
Create a new MySQL database and import the student_data.sql file to
create the required table and sample data.
Update the MySQL database connection details in the dbConnect class.
Build and run the project using a Java IDE or command-line tool.
To import student_data.sql into your mysql database.
